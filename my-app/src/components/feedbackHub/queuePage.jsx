      ...
      <div className="bg-[#1a1a2e] border-b border-white/10 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#d4af37] mb-1.5">Critique Queue</p>
              <h1 className="font-serif text-white text-2xl sm:text-3xl leading-tight mb-1.5">Queue</h1>

// src/pages/EventPage.jsx  (or wherever your event page lives)
// Updated to use the app's dark-blue theme: #0d1320 → #1e2d4a
    ...
    <FadeIn delay={60 + index * 40}>
      <div className="flex items-center gap-3 py-3 px-4 rounded-2xl transition-all hover:bg-white/5">
        <Link to={`/profile/${entry.userId}`}
          className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden border-2 hover:opacity-80 transition-opacity"
  ...
  return (
    <FadeIn delay={80 + index * 60}>
      <div className={`relative rounded-2xl p-5 border transition-all ${
        isIronPen  ? "bg-gradient-to-br from-purple-900/30 to-purple-800/10 border-purple-500/20"
        : isChampion ? "bg-gradient-to-br from-[#d4af37]/15 to-[#d4af37]/5 border-[#d4af37]/25"
        : "border-white/10"
      }`} style={{ background: isIronPen || isChampion ? undefined : "rgba(255,255,255,0.04)" }}>
        <div className="flex items-center gap-4">
          ...
          <Link to={`/profile/${winner.user?.id}`}
            className="w-11 h-11 rounded-full flex items-center justify-center text-white text-sm font-bold flex-shrink-0 overflow-hidden border-2 hover:opacity-80 transition-opacity"
            style={{
              borderColor: isIronPen ? "rgba(196,181,253,0.5)" : isChampion ? "rgba(212,175,55,0.5)" : "rgba(255,255,255,0.15)",
...
export default function EventPage() {
  ...
  // ── Shared dark-blue background ───────────────────────────
  const pageBg = "linear-gradient(160deg, #0d1320 0%, #141c2e 35%, #1a2540 65%, #1e2d4a 100%)";
  ...
  if (error || !event) return (
    <div className="min-h-screen" style={{ background: pageBg }}>
      ...
      <div className="max-w-3xl mx-auto px-4 py-32 text-center">
        ...
        <p className="text-white/50 mb-2">{error || "Event not found."}</p>
  ...
  return (
    <div className="min-h-screen" style={{ background: pageBg }}>
      ...
      <div className="relative overflow-hidden">
        {/* Ambient glow — blue tint matching App.jsx */}
        <div
        ...
        {event.bannerUrl && (
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, rgba(13,19,32,0.3), rgba(13,19,32,0.97))" }} />
          </div>
        )}
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 pt-10 pb-16">
          ...
          <FadeIn delay={0}>
            <Link to="/events"
              className="inline-flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-widest text-white/35 hover:text-white/70 transition-colors mb-8">
                ...
                <div className="rounded-3xl border overflow-hidden"
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      <StatPill label="Top Words" value={fmt(Math.max(...winnersData.winners.map(w => w.totalWords || 0)))}               emoji="✍️" />
                    </div>
                  </div>
                </div>
              </FadeIn>
      ...
      {/* ── DIVIDER ────────────────────────────────────────── */}
      <div className="h-px w-full" style={{ background: "linear-gradient(90deg, transparent, rgba(37,99,235,0.25), transparent)" }} />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14 space-y-10">
          ...
          return (
            <FadeIn delay={80}>
              <section>
                ...
                <div className="rounded-3xl border overflow-hidden"
                  style={{ background: "rgba(37,99,235,0.03)", borderColor: "rgba(37,99,235,0.12)" }}>
                  <div className="p-2">
        ...
        {/* Empty — active but no participants */}
        {isChallenge && isActive && !hasLeaderboard && (
          <FadeIn delay={60}>
      ...
      <div className="h-px w-full" style={{ background: "linear-gradient(90deg, transparent, rgba(37,99,235,0.12), transparent)" }} />
      <div className="pb-16" />
    </div>
  );
}